...
const SidebarTrigger = React.forwardRef<
  React.ElementRef<typeof RevButtons>,
  React.ComponentProps<typeof RevButtons>
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 border-[#3F3F3F] bg-primary-foreground flex-col gap-2 overflow-auto group-data-[collapsible=icon]:overflow-hidden",
        className
      )}
      {...props}
    />
