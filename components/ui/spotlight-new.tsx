...
export const Spotlight = ({
  ...
  gradientSecond = "radial-gradient(50% 50% at 50% 50%, hsla(230, 100%, 85%, .06) 0, hsla(230, 100%, 55%, .02) 80%, transparent 100%)",
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        maskImage:
          "linear-gradient(to bottom, rgba(0, 0, 0, 1) 0%, rgba(0, 0, 0, 0) 33%)", // Fade effect
        WebkitMaskImage:
