        ...
        <Body className="bg-white my-auto mx-auto font-sans px-2">
          <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] max-w-[465px]">
            ...
            <Heading className="text-black text-[24px] font-normal text-center p-0 my-[30px] mx-0">
              <strong>{memberName}</strong> accepted your invitation to{" "}
            ...
            <Text className="text-black text-[14px] leading-[24px]">
              They now have access to {roleDescriptions[role]} in your project.
            ...
            <Text className="text-[#666666] text-[12px] leading-[24px]">
              This notification was sent because {memberName} accepted your
              invitation to join your project.
            </Text>
            <Text className="text-[#666666] text-[12px] leading-[24px]">
